<div class="w-full h-full bg-black/50 absolute top-0 left-0">
  <div class="realrounded-2xl border border-blue-100 bg-white p-4 shadow-lg sm:p-6 lg:p-8" role="alert">
